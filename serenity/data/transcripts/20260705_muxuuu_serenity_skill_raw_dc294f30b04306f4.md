---
id: 20260705_muxuuu_serenity_skill_raw_dc294f30b04306f4
author: Serenity / @aleabitoreddit research corpus
source_name: muxuuu_serenity_skill_raw
...
- `ai_capex` AI算力Capex (terms: 算力)
- `cpo_optical` CPO/光通訊 (terms: CPO)
- `inp_photonics` InP磷化銦光子 (terms: InP)
- `silicon_photonics` 矽光子/SiPh (terms: silicon photonics)
- `hvdc_power_semiconductor` HVDC功率半導體 (terms: SiC)

## Matched Companies

- `CCL` Carnival Corp Ltd. (terms: CCL)
- `D` DOMINION ENERGY, INC (terms: D)
- `HBM` Hudbay Minerals Inc. (terms: HBM)
- `PCB` PCB BANCORP (terms: PCB)
