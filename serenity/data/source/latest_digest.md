...
Updated at: 2026-07-10T23:30:08+00:00

## Source Status

| Source | Status | Strength | URL |
|---|---:|---|---|
| x_profile_direct | ok | weak_lead | https://x.com/aleabitoreddit |
| x_with_replies_jina | HTTP 403 | weak_lead | https://r.jina.ai/http://x.com/aleabitoreddit/with_replies |
| serenity_method_youminds | HTTP 404 | secondary | https://youmind.com/landing/x-viral-articles/serenity-ai-supply-chain-alpha |
| muxuuu_serenity_skill_raw | ok | secondary | https://raw.githubusercontent.com/muxuuu/serenity-skill/main/SKILL.md |
| thelec_sdi_simplo_bbu | ok | medium | https://www.thelec.net/news/articleView.html?idxno=11952 |
| thelec_sdi_40v3_bbu | ok | medium | https://www.thelec.net/news/articleView.html?idxno=6792 |

## Extracted Leads

### x_profile_direct (weak_lead)
...
### muxuuu_serenity_skill_raw (secondary)
- description: Turn an investment agent into a supply-chain bottleneck hunter. Use this skill for source-backed investment research, live market/theme scans, AI/semi/technology value-chain mapping, A-share/HK/US stock screening, thesis stress tests, and Serenity-inspired research conversations. Trigger on requests like "用 Serenity 的方式看", "深度调研", ...
...
- Cumulative posts: 59 (2 new)
- Transcript files: 36
- Theme evidence rows for ThemeMiner: 36
- Company mention rows: 143
