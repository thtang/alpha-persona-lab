...
```bash
python3 thememiner/scripts/discover_market_universe.py --markets US,TW,TWO --agent-mode on --agent-provider codex --agent-workers 3 --agent-batch-size 16
...
```bash
python3 thememiner/scripts/discover_market_universe.py --markets US,TW,TWO --max-symbols 2500
...
python3 thememiner/scripts/update_theme_graph.py --refresh-prices --refresh-news
python3 thememiner/scripts/build_company_thesis_cards.py --agent-mode auto
python3 thememiner/scripts/discover_market_universe.py --markets US,TW,TWO
python3 thememiner/scripts/discover_market_universe.py --markets US,TW,TWO --agent-mode auto --agent-limit 300
