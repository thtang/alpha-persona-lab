...
- 台積電估值與權值股拖拉: episodes=485, hits=16836, top_terms={'台積': 5912, '台積電': 5481, '營收': 1496, '外資': 1360, 'EPS': 1025, '本益比': 843}
- 台股/台指方向: episodes=561, hits=14400, top_terms={'台股': 3512, '創新高': 2176, '大盤': 1834, '萬點': 1708, '拉回': 1384, '崩盤': 1048}
- 績效/會員/權威敘事: episodes=441, hits=12700, top_terms={'會員': 4605, '賺錢': 2724, '獲利': 1564, '投資長': 1515, '績效': 917, '冠軍': 599}
- AI伺服器與供應鏈: episodes=517, hits=9734, top_terms={'AI': 7397, '鴻海': 957, '廣達': 641, '伺服器': 345, '輝達': 202, '緯創': 110}
- 記憶體循環: episodes=435, hits=8090, top_terms={'記憶體': 4648, '南亞科': 2784, '群聯': 196, '美光': 175, 'HBM': 90, 'DDR4': 64}
- 風險控制與進出紀律: episodes=487, hits=6646, top_terms={'獲利': 1564, '注意': 1391, '拉回': 1384, '風險': 939, '回檔': 802, '下車': 191}
- 美債/匯率/資金面: episodes=425, hits=5561, top_terms={'美債': 1855, '台幣': 1004, '降息': 958, '資金': 760, '利率': 407, '美元': 333}
...
- 加權指數 ^TWII: episodes=544, hits=8771, aliases={'台股': 3512, '台灣股市': 3384, '大盤': 1834, '加權指數': 41}
- ai_supply_chain : episodes=474, hits=8006, aliases={'AI': 7397, '伺服器': 345, 'AI伺服器': 215, '人工智慧': 35, 'GB300': 14}
- memory : episodes=373, hits=4842, aliases={'記憶體': 4648, 'HBM': 90, 'DDR4': 64, 'DDR5': 32, 'DRAM': 8}
...
- 元大台灣50 0050.TW: episodes=309, hits=1930, aliases={'台灣50': 1170, '0050': 757, '元大台灣50': 3}
...
- 二分對照與轉折 (contrast): episodes=505, hits=36688
- 績效榜單與會員見證 (authority): episodes=406, hits=7233
- 散戶焦慮與踏空痛點 (fear_control): episodes=420, hits=6614
- 財富畫面與漲幅承諾 (social_proof): episodes=472, hits=5631
- 數據節點驗證 (authority): episodes=436, hits=4793
